...
class QuantModel(nn.Module):
    ...
    def quant_model_refactor(self, module: nn.Module, weight_quant_params: dict = {}, act_quant_params: dict = {}):
        """
        ...
        for name, child_module in module.named_children():
            if type(child_module) in specials:
                ...
                self.quant_model_refactor(child_module, weight_quant_params, act_quant_params)
    ...
    def set_first_last_layer_to_8bit(self):
        ...
        module_list[-2].weight_quantizer.bitwidt_refactor(8)
