...
if __name__ == '__main__':
    ...
    kwargs = dict(cali_data=cali_data, iters=args.iter_w, weight=args.weight, asym=True, b_range=(args.b_start, args.b_end), warmup=args.warmup, act_quant=False, opt_mode="mse")
